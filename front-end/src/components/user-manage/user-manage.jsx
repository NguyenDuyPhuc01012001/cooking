						...
						<Switch>
							...
							<div className="user-manage__container">
								<div className="user-manage__menu">
									<LeftMenuUser
										parentCallBackTitle={this.callBackTitle}
										parentCallBackName={this.callBackName}
									></LeftMenuUser>
								</div>
								<div className="user-manage__content">
									...
									<div className="user-manage__view">
										...
										<Route
											exact
											path="/user/manage/favourite"
											component={ContentComponent}
										/>
										<Route
											exact
											path="/user/manage/password"
											component={ContentComponent}
										/>
										<Route
											exact
											path="/user/manage/notification"
											component={ContentComponent}
										/>
										<Route
											exact
											path="/user/manage/setting"
											component={ContentComponent}
										/>
									</div>
									<FooterManage />
