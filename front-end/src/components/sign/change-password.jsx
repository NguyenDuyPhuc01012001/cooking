				...
				<div className="bg-white">
					...
					<div className="change-pass-container">
						<div className="change-pass-header">
							<span></span>
							<span className="weight-500 m-top-28 font-24">
								Thay đổi mật khẩu
							</span>
						</div>
						...
						<div className="change-pass-content">
							<div
								className={isValidPassword ? 'input-field' : 'invalid-input'}
							>
								<input
									value={password}
							...
							{!isValidPassword && (
								<small className="change-password-text-danger">
									{passwordError}
								</small>
							)}
							<div
							...
							<button onClick={handleClick} className="change-password-btn">
								Đổi mật khẩu
							</button>
						</div>
					</div>
